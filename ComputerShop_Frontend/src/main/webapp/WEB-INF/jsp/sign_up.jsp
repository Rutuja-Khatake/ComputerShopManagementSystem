									...
									<div class="form-body">
										<form class="row g-3">
											<div class="col-12">
												...
												<input type="email" class="form-control" id="inputUsername" placeholder="Enter Username" name="username">
											</div>
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Email Address</label>
												<input type="email" class="form-control" id="inputEmailAddress" placeholder="Enter Email Address" name="emailaddress">
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												...
												<select class="form-select" id="inputSelectRole" aria-label="Default select example" name="role">
